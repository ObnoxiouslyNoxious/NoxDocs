...
!!! question "Does this Mod add usage for Money?"

    No, the Mod just spawns Money in the Zombie's loot. You would need to find other Mods to implement features to utilize or use the Money.
